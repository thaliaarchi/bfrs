[Move pointer x (empty) cells to the right

Attribution: Kman <https://esolangs.org/wiki/User:Kman>

Move your pointer to the right as many times as the value of x. (Non-Wrapping)
...
- Ensure there are zeroed cells before cell x, or the one next to cell x will
